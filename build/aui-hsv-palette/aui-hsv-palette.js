...
var AColor = A.Color,
    ...
    HSVPalette = A.Base.create('hsv-palette', A.Widget, [A.WidgetCssClass, A.WidgetToggle], {
        ...
        TPL_VIEW_CONTAINER: '<div class="row ' + CSS_VIEW_CONTAINER + '"></div>',

        TPL_IMAGE_BACKDROP: '<div class="' + CSS_HS_IMAGE_BACKDROP + '"></div>',

        TPL_IMAGE_WRAPPER: '<div class="col-md-6 ' +
        ...
        TPL_VALUE_CONTAINER: '<div class="col-md-6 ' + CSS_VALUE_CONTAINER + '"><div class="row"></div></div>',
